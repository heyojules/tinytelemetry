...
// renderPatternsModalWithViewport renders the patterns modal using the provided viewport.
func (m *DashboardModel) renderPatternsModalWithViewport(vp *viewport.Model, width, height int) string {
